...
//        case GBestiaux:   MvtAniFrm->VersGrilleInvAni(Agri->V_InvAni);break;
...
void __fastcall TAgriSaisieFrm::VersGrilleStockIni(CL_Vecteur<CL_StockIni> *vecteur)
{
	...
	for( r=0;r<nbelt;r++)
	{
		...
		row++;
		LaGrille->Cells[2][row]=L_PrixRevient; //"   Prix Revient";
		for(i=0,c=3;i<N_X;i++,c++)
...
/*
 L_PrixRevient=        "Prix Revient";
 L_PasDonAInt=         "Aucune Donnée à introduire";
 L_Cat=                "Catégorie";
