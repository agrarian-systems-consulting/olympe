...
#ifndef CalendrierancienH
#define CalendrierancienH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include <Grids.hpp>
//---------------------------------------------------------------------------
class TCalendrierAncienFrm: public TForme00Frm {
...
//    virtual bool  __fastcall Stocker(void);
	...
	__fastcall TCalendrierAncienFrm(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TCalendrierAncienFrm *CalendrierAncienFrm;
//---------------------------------------------------------------------------
#endif
